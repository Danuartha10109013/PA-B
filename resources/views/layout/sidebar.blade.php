...
<ul id="sidebarnav">
  ...
  <li class="sidebar-item {{ request()->routeIs('admin.kelolapegawai') ? 'active' : '' }}">
    <a class="sidebar-link {{ request()->routeIs('admin.kelolapegawai') ? 'active' : '' }}"
      href="{{route('admin.kelolapegawai')}}" aria-expanded="false">
      <span>
  ...
  <li class="sidebar-item {{ request()->routeIs('admin.kabsensi') ? 'active' : '' }}">
    <a class="sidebar-link {{ request()->routeIs('admin.kabsensi') ? 'active' : '' }}"
      href="{{route('admin.kabsensi')}}" aria-expanded="false">
      <span>
  ...
  <li class="sidebar-item {{ request()->routeIs('admin.kcuti') ? 'active' : '' }}">
    <a class="sidebar-link {{ request()->routeIs('admin.kcuti') ? 'active' : '' }}" href="{{route('admin.kcuti')}}"
      aria-expanded="false">
      <span>
